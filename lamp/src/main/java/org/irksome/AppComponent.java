...
public class AppComponent {
    ...
    protected void activate() {
        ...
        appId = coreService.registerApplication("org.irksome");
...
//             정상인 경우는 dst, 아니면 허니팟으로.
//                    hostService.getHost(HostId.hostId(HONEYPOT_MACADDRESS));
            ...
            // 이부분이 RRM 인가요? 주기적으로 바꾸면 되나요? Time
            if (path == null) {
